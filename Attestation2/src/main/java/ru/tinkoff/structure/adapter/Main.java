...
import ru.tinkoff.structure.adapter.printer.kazantcr.KazanTCRPrinterServiceImpl;
import ru.tinkoff.structure.adapter.printer.KazanTCRPrinterServiceAdapter;
import ru.tinkoff.structure.adapter.printer.vodniy.PrinterService;
import ru.tinkoff.structure.adapter.printer.vodniy.VodniyPrinterServiceImpl;
